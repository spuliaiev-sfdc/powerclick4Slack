...
const commandHelloWorld = require("./lib/commandHelloWorld")
...
app.command('/helloworld', async ({ ack, payload, context }) => {
  return commandHelloWorld.process(config, ack, payload, context);
});

app.command('/helloworld22', async ({ ack, payload, context }) => {
        ...
        blocks: [
          {
            ...
            "text": {
              "type": "mrkdwn",
              "text": "*Welcome to your _App's Home_* :tada: in the HEROKU!!"
            }
          },
          {
            "type": "divider"
